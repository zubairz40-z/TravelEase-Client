...
const Login =()=>{
	...
	<form noValidate="" action="" className="space-y-6">
		...
		<NavLink><button className="block w-full p-3 text-center rounded-md dark:text-gray-50 bg-red-700 text-sm font-semibold hover:bg-red-900 transition-colors">Login</button></NavLink>
	</form>
