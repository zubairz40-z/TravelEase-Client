...
const MyVehicles = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 min-h-[80vh] pt-10 ">
      ...
      {vehicles.length === 0 ? (
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {vehicles.map((vehicle) => {
            const mainImage = Array.isArray(vehicle.coverImage)
              ? vehicle.coverImage[0]
              : vehicle.coverImage;
              ...
              >
                ...
                {mainImage && (
                  <div className="h-40 overflow-hidden relative">
                    <img
                      src={mainImage}
                      alt={vehicle.vehicleName || "Vehicle Image"}
